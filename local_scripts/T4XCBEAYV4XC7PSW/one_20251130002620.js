...
__lastFoundElement_2 = text("我的").findOne(5000);
__lastFoundElement = __lastFoundElement_2;
if (!__lastFoundElement_2) { console.log("未找到控件: text=我的"); } else { console.log("找到控件: text=我的"); }

// 节点: 逻辑或 (OR) (n_1764433520279_6)
let v_n_1764433520279_6 = null;
const A = __lastFoundElement_1;
const B = __lastFoundElement_2;
(function(){
  try {
    const __val = (A || B);
    v_n_1764433520279_6 = __val;
    console.log("逻辑或结果: " + String(__val));
    if (!__val) {
      console.log("逻辑或不满足");
    }
  } catch (e) {
    console.log("逻辑或表达式错误: " + String(e));
  }
})();

// 节点: 点击控件 (n_1764432950494_5)
let v_n_1764432950494_5 = null;
if (!v_n_1764433520279_6) {
